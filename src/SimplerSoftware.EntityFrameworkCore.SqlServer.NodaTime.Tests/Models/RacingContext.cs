    ...
    public class RacingContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Race>()
                .HasData(
                    new Race { Id = 1, Date = new LocalDate(2019, 1, 1), ScheduledStart = new LocalTime(8, 0, 0) },
                    new Race { Id = 2, Date = new LocalDate(2019, 2, 1), ScheduledStart = new LocalTime(9, 0, 0) },
                    new Race { Id = 3, Date = new LocalDate(2019, 3, 1), ScheduledStart = new LocalTime(10, 0, 0) },
                    new Race { Id = 4, Date = new LocalDate(2019, 4, 1), ScheduledStart = new LocalTime(11, 0, 0) },
                    new Race { Id = 5, Date = new LocalDate(2019, 5, 1), ScheduledStart = new LocalTime(12, 0, 0) },
                    new Race { Id = 6, Date = new LocalDate(2019, 6, 1), ScheduledStart = new LocalTime(13, 0, 0) },
                    new Race { Id = 7, Date = new LocalDate(2019, 7, 1), ScheduledStart = new LocalTime(14, 0, 0) },
                    new Race { Id = 8, Date = new LocalDate(2019, 8, 1), ScheduledStart = new LocalTime(15, 0, 0) },
                    new Race { Id = 9, Date = new LocalDate(2019, 9, 1), ScheduledStart = new LocalTime(16, 0, 0) },
                    new Race { Id = 10, Date = new LocalDate(2019, 10, 1), ScheduledStart = new LocalTime(17, 0, 0) },
                    new Race { Id = 11, Date = new LocalDate(2019, 11, 1), ScheduledStart = new LocalTime(18, 0, 0) },
                    new Race { Id = 12, Date = new LocalDate(2019, 12, 1), ScheduledStart = new LocalTime(19, 0, 0) }
                );
