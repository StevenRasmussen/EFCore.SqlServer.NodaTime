...
namespace SimplerSoftware.EntityFrameworkCore.SqlServer.NodaTime.Tests
{
    public class OffsetDateTimeQueryTests : QueryTestBase
    {
        ...
        public async Task OffsetDateTime_can_be_used_in_query()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE [r].[StartTimeOffset] = '2019-07-01T14:00:00.0000000+05:00'"),
        ...
        public async Task OffsetDateTime_PlusYears()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEADD(year, CAST(1 AS int), [r].[StartTimeOffset]) = '2020-07-01T14:00:00.0000000+05:00'"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_PlusMonths()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEADD(month, CAST(1 AS int), [r].[StartTimeOffset]) = '2019-07-01T13:00:00.0000000+05:00'"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_PlusDays()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEADD(day, CAST(30.0E0 AS int), [r].[StartTimeOffset]) = '2019-07-01T13:00:00.0000000+05:00'"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_PlusHours()
        {
            ...
            Assert.Equal(
                 condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEADD(hour, CAST(1 AS int), [r].[StartTimeOffset]) = '2019-07-01T15:00:00.0000000+05:00'"),
                 condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_PlusMinutes()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEADD(minute, CAST(60 AS int), [r].[StartTimeOffset]) = '2019-07-01T15:00:00.0000000+05:00'"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_PlusSeconds()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEADD(second, CAST(CAST(3600 AS bigint) AS int), [r].[StartTimeOffset]) = '2019-07-01T15:00:00.0000000+05:00'"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_PlusMilliseconds()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEADD(millisecond, CAST(CAST(3600000 AS bigint) AS int), [r].[StartTimeOffset]) = '2019-07-01T15:00:00.0000000+05:00'"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Year()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(year, [r].[StartTimeOffset]) = 2019"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Quarter()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(quarter, [r].[StartTimeOffset]) = 4"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Month()
        {
            ...
            Assert.Equal(
                 condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(month, [r].[StartTimeOffset]) = 12"),
                 condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_DayOfYear()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(dayofyear, [r].[StartTimeOffset]) = 1"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Day()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(day, [r].[StartTimeOffset]) = 1"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Week()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(week, [r].[StartTimeOffset]) = 1"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_WeekDay()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(weekday, [r].[StartTimeOffset]) = 1"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Hour()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(hour, [r].[StartTimeOffset]) = 12"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Minute()
        {
            ...
            Assert.Equal(
                 condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(minute, [r].[StartTimeOffset]) = 0"),
                 condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Second()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(second, [r].[StartTimeOffset]) = 0"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Millisecond()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(millisecond, [r].[StartTimeOffset]) = 0"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Microsecond()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(microsecond, [r].[StartTimeOffset]) = 0"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_Nanosecond()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(nanosecond, [r].[StartTimeOffset]) = 0"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_TzOffset()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(tzoffset, [r].[StartTimeOffset]) = 300"),
                condense(this.Db.Sql));
        ...
        public async Task OffsetDateTime_DatePart_IsoWeek()
        {
            ...
            Assert.Equal(
                condense(@"SELECT [r].[Id], [r].[EndTime], [r].[StartTime], [r].[StartTimeOffset] FROM [RaceResult] AS [r] WHERE DATEPART(iso_week, [r].[StartTimeOffset]) = 1"),
                condense(this.Db.Sql));
